...
// declare var Physijs.scripts.worker = '../libs/physijs_worker.js';
// declare var Physijs.scripts.ammo = '../libs/ammo.js';
...
export class MaterialPropertiesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    Physijs.scripts.worker = '../assets/libs/physijs_worker.js';
